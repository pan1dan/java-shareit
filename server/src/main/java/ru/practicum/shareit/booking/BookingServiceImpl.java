...
public class BookingServiceImpl implements BookingService {
    ...
    private void isStateRight(String bookingState) {
        try {
            log.info(BookingState.valueOf(bookingState).toString());
            BookingState.valueOf(bookingState);
        } catch (Exception e) {
            throw new BadRequestException("Недопустимое значение состояния: " + bookingState);
        }
    }
